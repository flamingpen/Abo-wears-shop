...
export const CATEGORIES = [
  ...
  { id: "gloves", label: "Gloves", icon: "🥊", description: "Sports & training gloves" },
] as const;

// Placeholder image URLs for non-jersey categories
